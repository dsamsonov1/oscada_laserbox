...
//OpenSCADA module DAQ.Laserbox file: module.h
/***************************************************************************
...
class TMdContr: public TController
{
	...
	string serialID () { return cfg("SERIALID").getS(); }
...
//    TElem &prmEL( )		{     mess_note(nodePath().c_str(), "prmEl called."); return pEl; }
